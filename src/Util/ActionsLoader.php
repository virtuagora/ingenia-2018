...
class ActionsLoader
{
    ...
    public function up()
    {
        $this->db->table('actions')->insert([
            ...
            ['id' => 'retGroFull', 'group' => 'project', 'allowed_roles' => '["admin"]', 'allowed_relations' => '["responsable"]', 'allowed_proxies' => '[]'],
            ['id' => 'retProFull', 'group' => 'project', 'allowed_roles' => '["admin"]', 'allowed_relations' => '["responsable"]', 'allowed_proxies' => '[]'],
