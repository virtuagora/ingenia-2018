<template>
  <div>
    ...
    <p v-if="user.subject.img_type === 1"><i class="fas fa-check has-text-success fa-fw fa-lg"></i><i class="fab fa-facebook has-text-link fa-fw fa-lg"></i>&nbsp;Utilizando mi perfil de Facebook: <a :href="'https://facebook.com/' + user.subject.img_hash">{{user.subject.display_name}}</a></p>
    <br>
    <label class="label is-size-5">
